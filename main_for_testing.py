...
def main():
    ...
    while not done:
        ...
        background_image = pygame.image.load("progbasics-rpg_game-thedragonslayers/images/dragon.jpeg").convert()
    ...
    while not gender:
        size = (1000, 571)
        screen = pygame.display.set_mode(size)
        background_image = pygame.image.load("progbasics-rpg_game-thedragonslayers/images/forest.jpg").convert()
        screen.blit(background_image, [0, 0])
    ...
    while not MAIN: 
        size = (1000, 571)
        screen = pygame.display.set_mode(size)
        background_image = pygame.image.load("progbasics-rpg_game-thedragonslayers/images/maxresdefault.jpg").convert()
        screen.blit(background_image, [0, 0])
